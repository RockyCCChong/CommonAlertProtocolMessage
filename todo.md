...
- [x] Fix polygon vertex limit (allowIntersection: false was auto-closing at 3 vertices)
- [x] Remove Feed Ingestion page, route, tRPC procedures, DB table, and sidebar nav entry
