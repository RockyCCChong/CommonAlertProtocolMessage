...
import { AlertTriangle, CheckCircle2, Code2, FileSearch, History, Shield, Zap } from "lucide-react";
        ...
        <div className="container py-24 md:py-32">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl leading-relaxed">
              Compose, validate, and parse Common Alerting Protocol v1.2 messages.
